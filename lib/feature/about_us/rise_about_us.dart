...
import 'package:web_rise_consulting/feature/about_us/feature/about_us_about.dart';
import 'package:web_rise_consulting/feature/about_us/feature/business_standards_about.dart';
import 'package:web_rise_consulting/feature/about_us/feature/embark_excellence_about.dart';
import 'package:web_rise_consulting/feature/about_us/feature/header_about.dart';
import 'package:web_rise_consulting/feature/about_us/feature/rise_about.dart';
...
class RiseAboutUsScreen extends StatefulWidget {
  const RiseAboutUsScreen({super.key});

  @override
  State<RiseAboutUsScreen> createState() => _RiseAboutUsScreenState();
...
class _RiseAboutUsScreenState extends State<RiseAboutUsScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            appBar: RiseAppbar(appBarHeight: MediaQuery.of(context).size.width <= 1000 ?60 : 90),
     ...
     body: const SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            CreatingSuccess(),
            AboutUSAbout(),
            EmbarkExcellenceAbout(),
            BusinessStandardsAbout(),
