...
import 'package:web_rise_consulting/feature/support/feature/cookie_policy.dart';
...
class RiseCookieScreen extends StatefulWidget {
  const RiseCookieScreen({super.key});

  @override
  State<RiseCookieScreen> createState() => _RiseCookieScreenState();
...
class _RiseCookieScreenState extends State<RiseCookieScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: RiseAppbar(
