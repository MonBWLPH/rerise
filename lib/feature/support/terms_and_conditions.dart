...
import 'package:web_rise_consulting/feature/support/feature/terms_and_conditions.dart';
...
class RiseTermsAndConditionsScreen extends StatefulWidget {
  const RiseTermsAndConditionsScreen({super.key});

  @override
  State<RiseTermsAndConditionsScreen> createState() => _RiseTermsAndConditionsScreenState();
...
class _RiseTermsAndConditionsScreenState extends State<RiseTermsAndConditionsScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: RiseAppbar(
